                ...
                <main>
                   <!-- <Button><a href="https://matias.ma/nsfw/" style="font-size: 50;">xd</a></Button> -->
                        ...
                        <h1>Lista de Pagos</h1>
                            <a href="PagosRegistrar.php?usuid=<?= $_GET['usuid']?>&emp=<?= $_GET['emp']?>&sucu=<?=$_GET['sucu']?>" class="btn btn-primary">Registrar</a>
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?=$cliente["pag_PrecioCompra"]?></td>
                                    <td><?=$cliente["pag_FechaCompra"]?></td>
                                    ...
                                    <td><a href="PagosEditar.php?id=<?= $cliente['pag_id']?>&usuid=<?= $_GET['usuid']?>&emp=<?= $_GET['emp']?>&sucu=<?=$_GET['sucu']?>" class="btn btn-warning">Editar</a></td>
                                    <td><a href="PagosEliminar.php?id=<?= $cliente['pag_id']?>&usuid=<?= $_GET['usuid']?>&emp=<?= $_GET['emp']?>&sucu=<?=$_GET['sucu']?>" class="btn btn-danger">Eliminar</a></td>
                                </tr>
                                <?php endforeach?>
                            </tbody>
                        </table>
