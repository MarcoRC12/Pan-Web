...
//aca
    ...
    $stock = json_decode($response, true);
      $st_id2 = end($stock['Detalle']);
     // var_dump($st_id2['st_id']); die;
...
<div class="container">
    ...
    <input type="text" name="st_CantidadAdquirida" placeholder="Cantidad Adquirida" class="form-control"> <br>
    <a> Cantidad Disponible
    <input type="text" name="st_CantidadDisponible" placeholder="Cantidad Disponible" class="form-control"> <br>
    <a> Codigo stock
    <input type="text" name="st_codigo" placeholder="Codigo" class="form-control"> <br>
		<!-- Hasta aca-->
    <!-- Sector pagos-->
    <a> Precio de la Compra
		<input type="text" name="pag_PrecioCompra" placeholder="Precio de la compra" class="form-control"> <br>
    <a> Fecha de la Compra
		<input type="input" name="pag_FechaCompra" placeholder="Fecha de la compra" class="form-control"> <br>
    <!-- Hasta aca-->
