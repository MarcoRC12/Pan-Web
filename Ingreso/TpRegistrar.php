...
<div class="container">
	...
	<form method="post" class="col-xl-8 offset-2">
		...
		<input type="text" name="tpro_nombre" placeholder="Nombre tipo del producto" class="form-control"> <br>
        <a> Descripcion
		<input type="text" name="tpro_descripcion" placeholder="Descripcion" class="form-control"> <br>
