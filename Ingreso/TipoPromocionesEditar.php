...
<div class="container">
    ...
    <input type="text" name="tpromo_nombre" placeholder="Nombre" value="<?= $data['Detalle']['tpromo_nombre']?>"  class="form-control">
    <input type="text" name="tpromo_descripcion" placeholder="Descripcion" value="<?= $data['Detalle']['tpromo_descripcion']?>" class="form-control">  </input>
		
		<button type="submit" class="btn btn-success">Guardar</button>
		<a href="TipoPromocion.php?usuid=<?= $_GET['usuid']?>&emp=<?= $_GET['emp']?>&sucu=<?=$_GET['sucu']?>" class="btn btn-danger">Cancelar</a>
	</form>
